...
export class Player extends GameObject {
    ...
    update(deltaTime) {
        ...
        if (input.keys["Space"] && this.canShoot) {
            ...
            // Strzał tylko, jeśli klawisz spacji został puszczony, a moc jest pełna
            if (this.isCharging && this.power >= MAX_POWER_CHARGE) {
                this.shootArrow();
            }
            this.isCharging = false;
            this.power = 0;
    ...
    shootArrow() {
        ...
        // Strzała zawsze leci ze stałą siłą, jak wcześniej ustalono
