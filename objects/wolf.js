...
import { GRAVITY, WOLF_WIDTH, WOLF_HEIGHT, WOLF_SPEED, WOLF_CHASE_DISTANCE, WOLF_ATTACK_DISTANCE, WOLF_RETREAT_DISTANCE, WOLF_ANIMATION_SPEED } from "../engine/Constants.js";
...
export class Wolf extends GameObject {
    ...
    constructor(x, y, player, game) {
        ...
        this.wolfSprites[0].src = "assets/sprites/wolf_sprites/wolf1.png";
        this.wolfSprites[1] = new Image();
        this.wolfSprites[1].src = "assets/sprites/wolf_sprites/wolf2.png";
        this.wolfSprites[2] = new Image();
        this.wolfSprites[2].src = "assets/sprites/wolf_sprites/wolf3.png";
        this.wolfSprites[3] = new Image();
        this.wolfSprites[3].src = "assets/sprites/wolf_sprites/wolf4.png";
        ...
        if (isApproachingDanger) {
            ...
            switch (this.state) {
                case "idle":
                    ...
                    this.dx = WOLF_SPEED * this.patrolDirection;
                ...
                case "chase":
                    if (distanceToPlayer < WOLF_ATTACK_DISTANCE) {
                        ...
                        this.dx = (this.player.x > this.x) ? WOLF_SPEED : -WOLF_SPEED;
